<template>
  ...
  >
    ...
    <el-container v-if="super_user_manage_show">
      ...
      <el-main>
        <el-scrollbar>
          <el-table :data="super_user_data" style="width: 100%">
            ...
            <el-table-column align="right">
              ...
              <template #default="scope">
                <el-button
                  size="small"
                  type="danger"
                  @click="handleDeleteSiperUser(scope.$index)"
                  >Delete</el-button
                >
              </template>
            </el-table-column>
  ...
  >
    ...
    <el-row>
      ...
      <span>性别：</span>
      <el-select v-model="newSuperUser.gender">
    ...
    <span class="dialog-footer">
      ...
      <el-button type="primary" @click="close_super_dia">Confirm2</el-button>
    </span>
  </el-dialog>
  <!-- 普通用户弹窗 -->
  <el-dialog
  ...
  >
    ...
    <el-row>
      ...
      <span>性别：</span>
      <el-select v-model="tempData.gender">
        <el-option label="男" value="男" />
        <el-option label="女" value="女" />
      </el-select>
    </el-row>
...
export default {
  ...
  methods: {
    ...
    handleEdit(index) {
      this.diatype = "Edit";
      this.diashow = true;
      this.tempData = deepClone(this.tableData[index]);
    ...
    close_dia() {
      if (this.diatype == "Edit") {
        this.tableData[this.chosed_index] = deepClone(this.tempData);
        this.diashow = false;
        ElMessage({
          message: "修改成功！",
          type: "success",
        ...
        this.tableData.push(deepClone(this.tempData));
        this.diashow = false;
        ElMessage({
          message: "添加成功！",
          type: "success",
    ...
    handleDeleteSiperUser(index) {
      this.super_user_data.splice(index, 1);
      ElMessage({
        message: "删除成功！",
        type: "success",
      });
    ...
    close_super_dia() {
      ...
      this.super_user_data.push(deepClone(this.newSuperUser));
